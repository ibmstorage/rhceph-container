...
LABEL summary="Provides the latest Red Hat Ceph Storage 9 on RHEL 10 in a fully featured and supported base image."
LABEL io.k8s.display-name="Red Hat Ceph Storage 9 on RHEL 10"
